 ...
 * 
 * @export
 * @interface SendSucessResponsetBody
 */
export interface SendSucessResponsetBody {
    /**
     * 
     * @type {string}
     * @memberof SendSucessResponsetBody
     */
    message?: string;
    /**
     * message ID
...
/**
 * Check if a given object implements the SendSucessResponsetBody interface.
 */
export function instanceOfSendSucessResponsetBody(value: object): value is SendSucessResponsetBody {
    return true;
}

export function SendSucessResponsetBodyFromJSON(json: any): SendSucessResponsetBody {
    return SendSucessResponsetBodyFromJSONTyped(json, false);
}

export function SendSucessResponsetBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendSucessResponsetBody {
    if (json == null) {
        return json;
    }
    return {
...
export function SendSucessResponsetBodyToJSON(json: any): SendSucessResponsetBody {
    return SendSucessResponsetBodyToJSONTyped(json, false);
}

export function SendSucessResponsetBodyToJSONTyped(value?: SendSucessResponsetBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
