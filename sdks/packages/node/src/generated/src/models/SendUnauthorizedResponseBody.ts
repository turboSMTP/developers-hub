 ...
 * 
 * @export
 * @interface SendUnauthorizedResponseBody
 */
export interface SendUnauthorizedResponseBody {
    /**
     * 
     * @type {number}
     * @memberof SendUnauthorizedResponseBody
     */
    errorCode?: number;
    /**
     * 
...
/**
 * Check if a given object implements the SendUnauthorizedResponseBody interface.
 */
export function instanceOfSendUnauthorizedResponseBody(value: object): value is SendUnauthorizedResponseBody {
    return true;
}

export function SendUnauthorizedResponseBodyFromJSON(json: any): SendUnauthorizedResponseBody {
    return SendUnauthorizedResponseBodyFromJSONTyped(json, false);
}

export function SendUnauthorizedResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendUnauthorizedResponseBody {
    if (json == null) {
        return json;
    }
    return {
...
export function SendUnauthorizedResponseBodyToJSON(json: any): SendUnauthorizedResponseBody {
    return SendUnauthorizedResponseBodyToJSONTyped(json, false);
}

export function SendUnauthorizedResponseBodyToJSONTyped(value?: SendUnauthorizedResponseBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
